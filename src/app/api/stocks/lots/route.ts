...
export async function POST(request: NextRequest) {
  try {
    ...
    const { pharmacieId, medicamentId, numeroLot, quantite, quantiteInitiale, prixAchat, dateExpiration } = body
    if (!pharmacieId || !medicamentId || !numeroLot || quantite === undefined || !quantiteInitiale || prixAchat === undefined || !dateExpiration) {
